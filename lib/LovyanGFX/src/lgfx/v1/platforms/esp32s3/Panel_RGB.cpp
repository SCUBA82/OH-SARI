...
//----------------------------------------------------------------------------
  ...
  const uint8_t* Panel_ST7701::getInitCommands(uint8_t listno) const
  {
    static constexpr const uint8_t list0[] =
    {
      ...
      0xC0,  2, 0x3B, 0x00, //LNESET Display Line Setting

      0xC1,  2, 0x10, 0x0C, //PORCTRL Porch Control | VBP = 16; VFP = 12
      0xC2,  2, 0x07, 0x0A, //INVSET Inversion selection & Frame Rate Control | Column; minimum number of pclk in each line = 672
      0xC7,  1, 0x00, //SDIR X-direction Control | source form 0 to 479
      0xCC,  1, 0x10, //NVM Program Active

      0xCD,  1, 0x08, //COLCTRL Color Control | pixel collect to DB[17:0].
...
//------------------------------------------------------------------------
      ...
      0xB0,  1, 0x5D, // Vop=4.7375v
      0xB1,  1, 0x3E, // VCOM=32
      0xB2,  1, 0x81, // VGH=15v
      0xB3,  1, 0x80,
      0xB5,  1, 0x4E, // VGL=-10.17v
      0xB7,  1, 0x85,
      0xB8,  1, 0x20, // AVDD=6.6 & AVCL=-4.6
      0xC1,  1, 0x78,
      0xC2,  1, 0x78,
      0xD0,  1, 0x88,

      0xE0,  3, 0x00, 0x00, 0x02, //SECTRL Sunlight Readable Enhancement | 

      0xE1, 11, 0x06, 0x30, 0x08, 0x30, 0x05, 0x30, 0x07, 0x30, 0x00, 0x33 , 0x33, //NRCTRL Noise Reduce Control
      0xE2, 12, 0x11, 0x11, 0x33, 0x33, 0xF4, 0x00, 0x00, 0x00, 0xF4, 0x00, 0x00, 0x00, //Sharpness Control

      0xE3,  4, 0x00, 0x00, 0x11, 0x11, //Color Calibration Control
      ...
      0xFF,  6, 0x08, 0x08, 0x08, 0x45, 0x3F, 0x54,

      //-----------VAP & VAN-------------
      // Command2 BK0 SEL deactivate
      ...
      0x3A,  1, 0x66, // 0x70 RGB888, 0x60 RGB666, 0x50 RGB565 //Color Mode 

      0x36,  1, 0x00, //Display data access control | ML= 0 Get normal scan.; BGR=0 RGB
      0x35,  1, 0x00, // Tearing Effect Line ON | OFF

      0x20, CMD_INIT_DELAY, 120, // Display Inversion Off

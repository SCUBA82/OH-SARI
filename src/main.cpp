/*
####### Stand alone DCS-BIOS SARI simulation using a 2.8" round display connected to a wave share ESP32-S3-LCD-Driver-Board
...
//#define DOUBLE_FRAME_BUFFER
#include "helper.h"
#include  <DcsBios.h>
#include <D:\Users\Chri\Documents\GitHub\OH-Software\Frontpanel\SARI-Test\SARI-Test\Assets\Addresses.h>
...
DcsBios::StringBuffer<16> AcftNameBuffer(MetadataStart_ACFT_NAME_A, onAcftNameChange);
//################## END DCS-BIOS ##################
...
void loop() {
 ...
 /* if (!ishornet){
  ...
  //Serial.print("Time is ");Serial.println(tim);
